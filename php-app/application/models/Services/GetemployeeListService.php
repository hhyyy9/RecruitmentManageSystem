...
class Services_GetemployeeListServiceModel extends Services_BaseServiceModel {
    ...
    protected function doExecute(){
        ...
        $pdoEmployeeList = Dao_EmployeeInfoModel::getEmployeeList();
    
        // convert and set value to $_ret
        $this->_ret = Utils::convertPdoRet($pdoEmployeeList);
    }
